    ...
    public class TeddyBear
    {
        ...
        public void Update(GameTime gameTime)
        {
            ...
            if (elapsedShotMilliseconds > firingDelay)
            {
                ...
                Projectile projectile = new Projectile(ProjectileType.TeddyBearProjectile,
                Game1.GetProjectileSprite(ProjectileType.TeddyBearProjectile),
                drawRectangle.X + drawRectangle.Width / 2,
                drawRectangle.Y + drawRectangle.Height + GameConstants.TeddyBearProjectileOffset,
                GameConstants.TeddyBearProjectileSpeed * Convert.ToSingle(Math.Sin(90)));

                this.shootSound.Play(0.05f, 0, 0);
        ...
        private void BounceTopBottom()
        {
            if (drawRectangle.Y < 0)
            {
                ...
                drawRectangle.Y = 0;
                velocity.Y *= -1;
                this.bounceSound.Play(0.1f, 0, 0);
            }
